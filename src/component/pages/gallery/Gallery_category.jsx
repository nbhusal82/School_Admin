...
const GalleryCategory = () => {
  ...
  const { data: response, isLoading } = useGetcategory_galleryQuery();
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">Gallery Categories</h1>
            <p className="text-xs text-gray-500 italic">Manage gallery categories</p>
          </div>
        </div>
              ...
              <tr key={cat.id} className="hover:bg-gray-50 transition">
                ...
                <td className="p-3">
                  <div className="flex justify-center gap-2">
                    ...
                    <button onClick={() => handleDelete(cat.id)} className="p-1.5 text-red-500 hover:bg-red-50 rounded-md transition"><Trash2 size={16} /></button>
                  </div>
                </td>
              </tr>
            ))}
