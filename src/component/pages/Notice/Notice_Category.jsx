...
const Notice_Category = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <PageHeader title="Notice Categories" subtitle="Manage notice categories">
        <button onClick={() => navigate("/admin/notice")} className="p-2 hover:bg-white rounded-full border border-transparent hover:border-gray-200 transition bg-white shadow-sm mr-2">
          <ArrowLeft size={20} className="text-gray-600" />
        </button>
