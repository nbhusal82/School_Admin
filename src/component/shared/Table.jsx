...
const Table = ({
  ...
  return (
    <div className={`bg-white shadow-sm border border-gray-200 overflow-x-auto ${wrapperClassName}`}>
      <table className={`min-w-full divide-y divide-gray-200 ${tableClassName}`}>
        ...
        <tbody className={`bg-white divide-y divide-gray-200 whitespace-nowrap ${bodyClassName}`}>
          {data && data.length > 0 ? (
